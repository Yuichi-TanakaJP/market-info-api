...
| `JPX_CLOSED_OBJECT_KEY` | `market_closed/jpx_market_closed_20260101_to_20271231.json` |

`JPX_CLOSED_OBJECT_KEY` は `/market-calendar/jpx-closed` 用の必須設定。
休場日 JSON の period が更新されたら、この値も同時に更新する。
